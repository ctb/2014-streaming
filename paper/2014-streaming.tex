...
an effective job of error correction.  In addition, these results
suggest that this may be a general approach for using genomic error
correction software on variable coverage data.
...
streaming approach shown in Figure~\ref{fig:concept} to {\em trimming}
reads.
