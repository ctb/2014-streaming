...
We used Quake v0.3.5, Jellyfish 1.1.11, Boost 1.57.0, and bowtie2 v2.1.0
...
scripts are in {\tt 2014-streaming/pipeline/}.
...
coverage of 20, except for the metagenomics data set, where we used
a coverage of 10.  Memory parameters were chosen for each data set so
that the false positive rate was under 1\%, which has no significant
effect on outcomes \cite{Zhang2014}.
